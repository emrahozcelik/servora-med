...
import { parseNotificationPage } from '../src/services/notifications-api';
...
describe('Messaging notification parser', () => {
  ...
  it('parses notification page with message.received and conversation entity', () => {
    const raw = {
      items: [{
        id: 'notif-1',
  ...
  it('parses read message.received notification correctly', () => {
    const raw = {
      items: [{
        id: 'notif-2',
        kind: 'message.received',
