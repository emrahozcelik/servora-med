...
export function ApprovalReport() {
  ...
  return <main className="workspace report-workspace"><header className="workspace-heading"><div><p className="eyebrow">Raporlar</p><h1>Onay kuyruğu</h1></div><nav className="report-nav" aria-label="Rapor bölümleri"><Link to={paths.reports}>Özet</Link><Link to={paths.deliveryReports}>Teslimler</Link></nav></header>
