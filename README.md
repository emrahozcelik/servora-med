...
| `HEALTH_SCHEMA_VERSION` | production | exact `schema_migrations.version` for readiness (current: `036_job_card_invalidated`; must equal the latest canonical migration in the deployed release); optional in development/test |
